...
#ifndef CPP_PROJECTS_BOOKSHOP_MANAGEMENT_CONSTANTS_H_
#define CPP_PROJECTS_BOOKSHOP_MANAGEMENT_CONSTANTS_H_
...
#endif  // CPP_PROJECTS_BOOKSHOP_MANAGEMENT_CONSTANTS_H_
